...
class GameLinksHeaderView: UIView {
    ...
    override func layoutSubviews() {
        ...
        topView.anchorView(top: self.topAnchor, left: self.leftAnchor, bottom: nil, right: self.rightAnchor, topPadding: 0, leftPadding: 15, bottomPadding: 0, rightPadding: 15, width: 0, height: 0.4)
