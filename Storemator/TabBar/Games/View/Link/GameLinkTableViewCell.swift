...
class GameLinkTableViewCell: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
     ...
     func layoutUI() {
        ...
        cellHeaderView.anchorView(top: self.topAnchor, left: self.leftAnchor, bottom: nil, right: self.rightAnchor, topPadding: 0, leftPadding: 0, bottomPadding: 0, rightPadding: 0, width: 0, height: 42)
        
        contentView.addSubview(cellTableView)
        cellTableView.anchorView(top: self.cellHeaderView.bottomAnchor, left: self.leftAnchor, bottom: nil, right: self.rightAnchor, topPadding: 0, leftPadding: 0, bottomPadding: 0, rightPadding: 0, width: 0, height: 270)
    }
